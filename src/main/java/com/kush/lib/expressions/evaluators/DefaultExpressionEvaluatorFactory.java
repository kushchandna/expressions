...
public class DefaultExpressionEvaluatorFactory<T> implements ExpressionEvaluatorFactory<T> {
    ...
    private class InternalExpressionEvaluatorFactory extends ExpressionProcessor<ExpressionEvaluator<T>> {
        ...
        @Override
        protected ExpressionEvaluator<T> handle(CustomFieldExpression expression) throws ExpressionException {
            return new CustomFieldExpressionEvaluator<>(expression, DefaultExpressionEvaluatorFactory.this);
        }
    }
}
